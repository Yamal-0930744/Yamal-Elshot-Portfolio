...
const withBase = (path = "") => {
  if (!path) return path;
  if (/^https?:\/\//i.test(path) || /^data:/i.test(path)) return path; // leave absolute/data URLs alone
...
export const projects = [
  {
    ...
    cover: withBase("/img/projects/logicare/logicarelogo.svg"),
    isLogo: true,
    media: [
      { type: "image", src: withBase("/img/projects/logicare/logicarebefore.png"),  caption: "Original dashboard (before)" },
      { type: "image", src: withBase("/img/projects/logicare/logicarebefore2.png"), caption: "Original dashboard (before)" },
      { type: "image", src: withBase("/img/projects/logicare/logicareduring.png"),  caption: "Wireframes & IA cleanup" },
      { type: "image", src: withBase("/img/projects/logicare/logicareduring2.png"), caption: "Wireframes & IA cleanup" },
      { type: "image", src: withBase("/img/projects/logicare/logicareduring3.png"), caption: "Wireframes & IA cleanup" },
      { type: "image", src: withBase("/img/projects/logicare/logicareafter.png"),   caption: "Redesigned dashboard (after)" }
    ],
    sections: {
      challenge: [
  ...
  {
    id: "threejs-first-character",
    title: "Three.js - First 3D Character",
    subtitle: "My first step into 3D on the web",
    tags: ["Three.js", "GLTF", "Animation"],
    cover: withBase("/img/projects/care4/carelogo.svg"),
    isLogo: true,
    media: [
      {
        type: "video",
        src: withBase("/img/projects/care4/film.mp4"),
        poster: withBase("/img/projects/care4/carelogo.svg"),
...

  {
    ...
    cover: withBase("/img/projects/landingpages/TKlogo.svg"),
    isLogo: true,
    media: [
      {
        type: "video",
        src: withBase("/img/projects/landingpages/janetcp.mp4"),
        caption: "JanetCP - variant walkthrough and CTA flow"
      },
      {
        type: "video",
        src: withBase("/img/projects/landingpages/welkomnapsales.mp4"),
...

  {
    ...
    cover: withBase("/img/projects/google/google.svg"),
    isLogo: true,
    media: [
      { type: "image", src: withBase("/img/projects/google/googleapi.svg"), caption: "Google OAuth consent & scopes" }
    ],
    sections: {
      challenge: [
...

  {
    ...
    cover: withBase("/img/projects/personality/personalitylogo.svg"),
    isLogo: true,
    media: [
      {
        type: "video",
        src: withBase("/img/projects/personality/personality.mp4"),
        poster: withBase("/img/projects/personality/personalitylogo.svg"),
        caption: "Typewriter intro → quiz flow → results share"
      },
      { type: "image", src: withBase("/img/projects/personality/firstscreen.png"),   caption: "Brand system and landing" },
      { type: "image", src: withBase("/img/projects/personality/teacherdashboard.png"), caption: "Teacher dashboard" }
    ],
    sections: {
      challenge: [
...

  {
    ...
    cover: withBase("/img/projects/bluealien/bluealien.svg"),
    isLogo: true,
    media: [
      {
        type: "video",
        src: withBase("/img/projects/bluealien/bluealiengame.mp4"),
        poster: withBase("/img/projects/bluealien/bluealienlogo.png"),
...

  {
    ...
    cover: withBase("/img/projects/n8n/n8n.svg"),
    isLogo: true,
    media: [
      { type: "image", src: withBase("/img/projects/n8n/ytxdsc.svg"), caption: "n8n workflow: Cron → YouTube → Format → Discord" }
    ],
    sections: {
      challenge: [
