      ...
      <div className="contactCard glass">
        ...
        <div className="socialRow" role="list" aria-label="Social links">
          <a role="listitem" aria-label="GitHub"
             href="https://github.com/your-handle" target="_blank" rel="noreferrer" className="social">
            {/* GitHub icon */}
          ...
          <a role="listitem" aria-label="LinkedIn"
             href="https://www.linkedin.com/in/your-handle/" target="_blank" rel="noreferrer" className="social">
            {/* LinkedIn icon */}
          ...
          <a role="listitem" aria-label="Email" href="mailto:youremail@example.com" className="social">
            {/* Mail icon */}
